...
class RemoveRolesCommand extends SlashCommandHandler {
  public override readonly definition = new SlashCommandBuilder()
    .setName("removeroles")
    .setDescription("Remove a role from multiple members at once.")
    .setDefaultMemberPermissions(PermissionFlagsBits.ManageRoles)
    .addRoleOption(input => input
      .setName("role")
      .setDescription("The role to remove from members.")
      .setRequired(true),
    )
...
export default new RemoveRolesCommand();
